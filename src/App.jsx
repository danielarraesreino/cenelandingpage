      ...
      <header className="fixed top-0 w-full bg-white shadow-sm z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src={logo} alt="CENE Logo" className="w-12 h-12 rounded-lg object-cover" />
            <div>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button className="bg-emerald-600 text-white px-6 py-2.5 rounded-full font-medium hover:bg-emerald-700 transition shadow-lg shadow-emerald-200">
              Acessar Plataforma
            </button>
          </div>
        </div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="flex items-center justify-center gap-2 bg-emerald-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-emerald-700 transition shadow-xl shadow-emerald-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition duration-300 border border-slate-100 group">
              ...
              <a href="#" className="text-emerald-600 font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition duration-300 border border-slate-100 group">
              ...
              <a href="#" className="text-purple-600 font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
                Ver cursos <ChevronRight size={18} />
              </a>
            </div>
          </div>
      ...
      <section className="py-20 bg-emerald-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Por que escolher o EAD do CENE?</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-emerald-800/50 p-6 rounded-2xl text-center border border-emerald-700">
                ...
                <p className="text-emerald-200 text-sm">Online e Flexível</p>
              </div>
              <div className="bg-emerald-800/50 p-6 rounded-2xl text-center border border-emerald-700">
                <Users className="w-10 h-10 mx-auto text-emerald-400 mb-4" />
                <h4 className="text-3xl font-bold mb-1">+15</h4>
                <p className="text-emerald-200 text-sm">Grandes Eventos Realizados</p>
              </div>
              <div className="bg-emerald-800/50 p-6 rounded-2xl text-center border border-emerald-700 col-span-2">
                 <p className="text-emerald-200 italic mb-4">"Profissionais renomadas, experientes e de universidades de primeira linha reuniram-se para formar nosso corpo docente."</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-emerald-50 py-20 border-t border-emerald-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-emerald-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-emerald-700 transition shadow-xl shadow-emerald-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <img src={logo} alt="CENE Logo" className="w-8 h-8 rounded object-cover" />
